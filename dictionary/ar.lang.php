<?php
  ...
  define("WELCOME_MESSAGE", "ممكن نساعدك بإيه النهارده؟");
  define("WELCOME_MESSAGE_2", 'مرحباً {{first_name}} 👋');
  define("WELCOME_MESSAGE_3", "كن آمناً، خليك في البيت 🏡.");

  define("HOTLINES_TITLE", "الخطوط الساخنة 📞");
  define("STATISTICS_TITLE", "إحصائيات 📊");
  ...
  define("LINKS_MESSAGE", "لمزيد من المعلومات");
